package com.kubji.kafkatraining.serialization.customSerialization;
...
public class VendorConsumerThread implements  Runnable {
    ...
    private static Properties createConsumerConfig(String brokers, String groupId) {
        ...
        props.put("value.deserializer", "com.kubji.kafkatraining.serialization.customSerialization.VendorDeserializer");
        return props;
    }
